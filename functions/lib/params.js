...
const OPEN_PIXEL_URL_PARAM = IS_DEPLOY_PHASE
  ? undefined
  : (0, params_1.defineSecret)('OPEN_PIXEL_URL')
const CLICK_REDIRECT_URL_PARAM = IS_DEPLOY_PHASE
  ? undefined
  : (0, params_1.defineSecret)('CLICK_REDIRECT_URL')
